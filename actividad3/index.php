...
$query = "SELECT * FROM papeleria_jairo";
...
// Título del PDF
$pdf->Cell(190, 10, 'Papeleria Jairo - Inventario', 0, 1, 'C');
$pdf->Ln(5);
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        $pdf->Cell(70, 10, $row['producto'], 1);
        $pdf->Cell(50, 10, $row['categoria'], 1);
        $pdf->Cell(30, 10, '$' . number_format($row['precio'], 2, '.', ''), 1); // Sin comas
